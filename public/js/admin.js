...
var deletingid = ''; // DASHBOARD TABLE

$('#myTable thead tr').clone(true).appendTo('#myTable thead');
$('#myTable thead tr:eq(1) th').removeClass();
$('#myTable thead tr:eq(1) th').each(function (i) {
  var title = $.trim($(this).text());
  $(this).html('<input class="block w-full rounded-md shadow-sm border-gray-300 focus:ring focus:ring-red-400 focus:ring-4" type="text" placeholder="' + title + '" />');
