...
$('#myTable thead tr:eq(1) th').each(function (i) {
  ...
  $(this).html('<input class="block w-full shadow-sm border-gray-300 focus:ring focus:ring-red-400 focus:ring-4" type="text" placeholder="' + title + '" />');
...
$('.deleteButton').on('click', function (e) {
  ...
  $.get('modal/delete/' + deletingid, function (data) {
    $('body').append(data);
  });
});
$('.recoverButton').on('click', function (e) {
  recoverid = e.currentTarget.id;
  $.get('modal/recover/' + recoverid, function (data) {
    $('body').append(data);
  });
}); // //////////////
// Modals!
